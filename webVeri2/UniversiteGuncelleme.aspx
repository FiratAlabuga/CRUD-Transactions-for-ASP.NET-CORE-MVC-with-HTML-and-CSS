<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UniversiteGuncelleme.aspx.cs" Inherits="webVeri2.UniversiteGuncelleme" %>
       ...
       <table class="style1">
            <tbody><tr>
                <td class="auto-style1">
                    Universite Güncelleme Sayfası</td>
                <td class="style4">
                     </td>
                <td>
                     </td>
            ...
            <tr>
                ...
                <tr>
                    <td class="style5">
                        <asp:Button runat="server" Text="Güncelleme" OnClick="btnGnclleme" CssClass="button" OnClientClick="uyari()" />
                    </td>
                </tr>
                <tr>
                    <td class="style6">
                        <asp:Button runat="server" Text="Ara" OnClick="btnArama" CssClass="button" />
                    </td>
                </tr>
